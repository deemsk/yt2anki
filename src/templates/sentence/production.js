...
export function buildProductionFront(russian, situation = null) {
  return html`
    ...
    <div class="yt2anki-production-source" style="font-size:20px;font-weight:700;line-height:1.28;text-align:center;">${escapeHtml(russian)}</div>
    ${situation ? `<div class="yt2anki-production-hint" style="margin-top:8px;font-size:13px;line-height:1.35;text-align:center;opacity:0.86;">${escapeHtml(situation)}</div>` : ''}
  `;
}
